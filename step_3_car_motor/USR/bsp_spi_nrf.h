...
#define TX_PLOAD_WIDTH  1   //发射数据通道有效数据宽度0~32Byte 
...
#define NRF_Read_IRQ()		  GPIO_ReadInputDataBit ( GPIOC, GPIO_Pin_7)  //中断引脚
#elif 1
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOB, GPIO_Pin_6)
#define NRF_CSN_LOW()       GPIO_ResetBits(GPIOB, GPIO_Pin_6)		        //csn置低
#define NRF_CE_HIGH()	      GPIO_SetBits(GPIOB,GPIO_Pin_5)
#define NRF_CE_LOW()	      GPIO_ResetBits(GPIOB,GPIO_Pin_5)			      //CE置低
#define NRF_Read_IRQ()		  GPIO_ReadInputDataBit ( GPIOB, GPIO_Pin_7)  //中断引脚
#endif
